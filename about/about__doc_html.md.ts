...
[//]: 💖
## ${icon_line_([
	svgrepo_sparkling_heart_({ class: 'inline-block h-4 w-4' }),
...
[//]: 👊🏼
## ${icon_line_([
	svgrepo_oncoming_fist_skin_2_({ class: 'inline-block h-4 w-4' }),
	'Skin in the game'
])} 
...
[//]: 🌐
## ${icon_line_([
	svgrepo_globe_with_meridians_({ class: 'inline-block h-4 w-4' }),
...
[//]: 🍯
## ${icon_line_([
	svgrepo_honey_pot_sweet_dessert_food_({ class: 'inline-block h-4 w-4' }),
...
[//]: 🚀
## ${icon_line_([
	svgrepo_rocket_({ class: 'inline-block h-4 w-4' }),
...
[//]: 🗓
## ${icon_line_([
	svgrepo_grid_({ class: 'inline-block h-4 w-4' }),
	'Flat Architecture & Name Systems'
])}
